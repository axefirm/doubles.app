...
class _CalendarTabState extends State<CalendarTab> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _events = {
      _selectedDay.add(Duration(days: 4)): ['Бичлэг хийх', 'Hackathon'],
